import { Grid2X2, Download, Upload, Pin, PinOff, ChevronUp, ChevronDown, Minus, X, Zap } from 'lucide-react'
  ...
  return (
    <header className="topbar">
      <div className="topbar-left">
        <span className="app-logo" aria-hidden="true"><Zap size={18} fill="currentColor" /></span>
